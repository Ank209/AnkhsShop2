...
(function() {
    ...
    function dataservice($http, $q, $timeout, breeze, logger) {
        ...
        function createRequest(initialValues) {
        ...
        function getRequests() {
            var query = breeze.EntityQuery
                .from("Requests").orderBy("Item.AisleNumber");
        ...
        function getItemTypes() {
            var query = breeze.EntityQuery
                .from("ItemTypes").orderBy("ItemTypeName");
        ...
        function getMovies() {
            var query = breeze.EntityQuery
                .from("Movies").orderBy("MainTitle, SequelNum");
        ...
        function verifyPass(userName, password) {
            ...
            var promise = $.get("breeze/todos/VerifyUser", { userName, password });
            return promise;
            function queryFailed(error) {
                logger.error(error.message, "Query failed");
                return $q.reject(error); // so downstream promise users know it failed
        ...
        function saveChanges() {
            ...
            function saveSucceeded(saveResult) {
                logger.log(saveResult.entities.length + " Requests updated.");
